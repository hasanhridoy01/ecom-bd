      ...
      <div className="navbar bg-base-100 p-3">
        ...
        <div className="navbar-center hidden lg:flex">
          <ul className="menu menu-horizontal p-0">
            <li><Link href='/'><a className="home">Home</a></Link></li>
            <li><Link href='/aboutus'><a className="about">About Us</a></Link></li>
            <li><Link href='/contectus'><a className="contect">Contect Us</a></Link></li>
          </ul>
        </div>
